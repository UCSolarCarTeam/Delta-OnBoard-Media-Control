...
OBJS = src/main.cpp src/SongLoader.cpp src/SongPlayer.cpp src/MusicBar.cpp include/threadClass.hpp src/videoStream.cpp src/WiringPiButtons.cpp src/backup_camera.cpp src/graphics_handler.cpp
